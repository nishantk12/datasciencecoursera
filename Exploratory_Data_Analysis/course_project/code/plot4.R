...
coal_source <- pol1 %>% filter(grepl("Coal", Short.Name))
...
plot(year_total_pol_coal$year, year_total_pol_coal$Emissions,col="blue",type="l",xlab="Years", ylab="Emission from all sources over the years")
